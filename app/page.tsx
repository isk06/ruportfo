...
сложных экономических и финансовых данных, анализ, сторителлинг и структурирование  (принцип Пирамиды, SCR-фреймворк), 
форматирование и верстка (Большая четверка, Большая тройка)</li>
