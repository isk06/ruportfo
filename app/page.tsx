            ...
            <div className="job-top-grid">
              ...
              <div>
                ...
                <ul className="fact-list">
                  ...
                  <li>Межотраслевой специалист с опытом работы в государственном секторе и консалтинге</li>
                  <li>Обширный опыт работы на руководящих и управленческих должностях</li>
                  <li>Экспертные навыки работы с Microsoft PowerPoint (включая макросы VBA)</li>
                  <li>Свободное владение Adobe Illustrator, Photoshop, Figma</li>
