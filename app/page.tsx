...
<section className="section">
  ...
  <p className="about">
    ...
    Эксперт в создании важных для бизнеса презентаций, структурировании 
  ...
  <ul className="about-list">
    ...
    <li>
      ...
      и финансовых данных, схем и метрик (Excel/PowerPoint), финансовые и кастомные диаграммы, 
      макросы PowerPoint (автоматизация форматирования).
    </li>
    <li>
    ...
    <li>
      ...
      (C-level, финансовые, консалтинговые, аналитические, маркетинговые), 
      клиентских отчетов, сторителлинг (Big4, Big3), структурирование информации, 
      анализ и визуализация, организация работы команды и оптимизация процессов.
    </li>
    <li>
