    ...
    <div className="hero-socials">
      ...
      <section className="section">
        ...
        <p className="about">
          ...
          -Cross-specialist with experience in the public sector and consulting. Extensive executive and managementexperience in federal executive bodies and consulting – both design and team lead work.
          -Competencies: presentation design and formatting (C-level, marketing, financial, consulting), reports,analysis and visualization, team organization and process optimization.
          -Subject areas: strategic consulting, investment banks, fintech, corporate finance, government economicprojects, IT, industry.
          -Specialization: visualization of complex economic and financial data, charts and metrics (Excel/PowerPoint),financial and custom diagrams, storytelling (Big3), information structuring, formatting and layout (Big4, Big3).
          -Products: business presentations, client reports, marketing materials (proposals, memos, one-pagers, annualreports), diagrams, maps, charts.
          -Broad industry expertise, quick immersion in new industries and business chains.
        </p>
      </section>
