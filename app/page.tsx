            ...
            <div className="job-top-grid">
              ...
              <div>
                ...
                <ul className="fact-list">
                  ...
                  <li>2+ опыта в дизайне в финансовом консалтинге</li>
                  ...
                  <li>Аналиp данных, выводы и рекомендации (so what?)</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="bullet-list">
                  ...
                  маркетинговые, финансовые, питчи), визуализация сложных экономических и финансовых данных, анализ, 
                  сторителлинг и структурирование  (принцип Пирамиды, SCR-фреймворк), форматирование и верстка (Big-4, MBB)</li>
                  <li><strong>Визуальные материалы:</strong> финансовые и 
                  пользовательские диаграммы (Excel/PowerPoint), карты, таблицы</li>
